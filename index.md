...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        body { background-color: #0f141c !important; color: #e6edf3 !important; font-family: sans-serif; padding: 20px; margin: 0; }
...
<body>
    <div class="container">
        ...
        <table>
            <thead>
                <tr><th style="width: 20%;">Data</th><th style="width: 50%;">Minaccia</th><th style="width: 30%;">Tag</th></tr>
            </thead>
            <tbody>
